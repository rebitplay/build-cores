...
if [ -z "${SETUP_CORES_CONFIG_LOADED:-}" ]; then
  ...
  CORE_REPOS=(
    ...
    "mgba_dual=git@github.com:rebitplay/mgba_dual.git#rebit"
    "gpsp=https://github.com/rebitplay/gpsp.git#rebit"
    "ppsspp=https://github.com/rebitplay/ppsspp.git"
    "azahar=https://github.com/rebitplay/azahar.git#rebit"
    "vbam=git@github.com:rebitplay/visualboyadvance-m.git#rebit"
    "pcsx_rearmed=https://github.com/rebitplay/pcsx_rearmed.git"
    "melonds=https://github.com/rebitplay/melonDS.git"
    "sameboy=git@github.com:rebitplay/SameBoy.git#libretro"
  )
